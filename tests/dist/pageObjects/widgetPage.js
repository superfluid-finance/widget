...
export class WidgetPage extends BasePage {
  ...
  chosenFlowRate;
  chosenToken;
  chosenFlowRatePeriod;
  continueButton;
  termsLink;
  privacyPolicyLink;
  wrapUnderlyingBalance;
  wrapSuperTokenBalance;
  wrapAmountInput;
  wrapAmountMirrorAmount;
  whyWrapTokensButton;
  reviewUnderlyingWrapAmount;
  reviewUnderlyingTokenSymbol;
  reviewSuperTokenAmount;
  reviewSuperTokenSymbol;
  reviewSuperTokenBalanceAndSymbol;
  senderAddress;
  receiverAddress;
  ...
  weRecomendMessage;
  transactionButton;
  successStreamedAmount;
  continueToMerchantButton;
  openSuperfluidDashboard;
  reviewExchangeRate;
  metamaskWalletButton;
  transactionStatuses;
  transactionTypes;
  transactionButtonLoadingSpinner;
  skipWrapButton;
  productDescription;
  productName;
  widgetErrorMessage;
  ...
  transactionSpinningProgress;
  reviewStepError;
  switchNetworkButton;
  customAmountInput;
  customAmountTimeUnitDropdown;
  openCheckoutInButton;
  dialogView;
  drawerView;
  fullScreenView;
  widgetContainer;
  ...
  circleIcons;
  checkmarkIcons;
  transactionTypesAndStatuses;
  // readonly copyButtons: Locator;
  // readonly productDetails: Locator;
  // readonly selectedNetworkBadge: Locator;
  poweredBySuperfluidButton;
  closeButton;
  chosenUpfrontFee;
  chosenOptionsPaperComponent;
  networkOptions;
  tokenOptions;
  web3ModalConnectionErrorMessage;
  wrapStepUnderlyingIcon;
  wrapStepSuperTokenIcon;
  reviewStepUnderlyingIcon;
  reviewStepSuperTokenIcon;
  reviewWrapSuperTokenComponent;
  reviewWrapUnderlyingTokenComponent;
  selectedTokenDuringTest;
  senderAddressDuringTest;
  receiverAddressDuringTest;
  wrapAmountDuringTest;
  underlyingTokenBalanceBeforeWrap;
  superTokenBalanceBeforeWrap;
  constructor(page) {
    super();
    this.page = page;
  ...
  async changeCustomPaymentAmount(amount, timeunit = "month") {
  ...
  async selectPaymentNetwork(network) {
  ...
  async selectPaymentToken(token) {
  ...
  async selectPaymentOption(paymentOption) {
  ...
  async validateTransactionStatuses(transactionList, statusList) {
    await test.step(`Validating transaction statuses`, async () => {
      for (const [index, transaction] of transactionList.entries()) {
        ...
        ).toHaveText(this.getTransactionTypeString(transaction));
        await expect(
  ...
  async validateAndSaveSenderAndReceiverAddresses(sender, receiver) {
  ...
  async validateWrapReviewAmount(amount) {
  ...
  async validateProductDescription(description) {
  ...
  async validateSelectedPaymentOption(option) {
  ...
  async validateTransactionCounterAndIcons(statusList) {
  ...
  async validateAndSaveWrapPageBalances(humanReadableNetworkName, superToken) {
  ...
  async validateReviewStepError(message) {
  ...
  async validateThatWrapAmountInputIs(amount) {
  ...
  async validateContainerBorderRadiusIs(radius) {
  ...
  async validateFieldBorderRadiusIs(radius) {
  ...
  async validateButtonBorderRadiusIs(radius) {
  ...
  async validatePrimaryColorIs(color) {
  ...
  async validateSecondaryColorIs(color) {
  ...
  async validateWidgetFontIs(font) {
  ...
  async validateAvailablePaymentOptions(options) {
  ...
  async searchForPaymentOptionNetwork(network) {
  ...
  async validateOnlyNetworksContainingTextAreVisible(network) {
  ...
  async validateTokenIcon(testTokenSymbol, element) {
    await expect(element).toHaveScreenshot(`data-${testTokenSymbol}.png`, {
      maxDiffPixelRatio: 0.11,
    });
  }
  async validateTokenIconInPaymentOptionStep(testTokenSymbol) {
  ...
  async validateTokenIconsInWrapStep(testTokenSymbol) {
  ...
  async validateTokenIconsInReviewStep(testTokenSymbol) {

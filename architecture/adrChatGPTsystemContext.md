...
```md
# Documenting Architecture Decisions (Abridged Version For ChatGPT)
...
- **Title** These documents have names that are short noun phrases. For example, "Deployment on Ruby on Rails 3.0.10" or "LDAP for Multitenant Integration"
